  ...
  return (
    ...
    <div className="bg-cream-50 min-h-screen">
      ...
      <div className="container mx-auto px-4">
        <br />
        <h2 className="text-2xl font-bold text-white mb-8 text-center">Get in Touch With Us</h2>
...
<p className="text-sm md:text-base text-gray-400">For all orders over $50 ,,consectetur <br />adipim scing elit</p>
</div>
<div>
...
<p className="text-sm md:text-base text-gray-400">100% secure payment,consectetur <br />adipim scing elit</p>
</div>
</div>
    </div>
                <Footer />
